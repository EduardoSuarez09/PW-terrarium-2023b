...
function dragElement(terrariumElement){
    ...
    function pointerDrag( event ){
        ...
        // Registrando handlers para evento
        ...
        function elementDrag (event) {
            ...
            // calculadas de modo que la imagen 
            // quede en la nueva posicion del mouse
            terrariumElement.style.left = `${terrariumElement.offsetLeft - pos1}px`;
            terrariumElement.style.top = `${terrariumElement.offsetTop - pos2}px`;

        }
        function stopElementDrag (event){
        // Eliminando hanlder para evento 
        // de arrastre           
        document.onpointermove = null;
        //Eliminando handler para evento 
        // de liberaicon del boton
